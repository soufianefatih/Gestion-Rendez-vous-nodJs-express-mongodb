...
{user.map((users, index) => (
                                ...
                                <div className="widget-heading">{users.email}</div>
                                   ...
                                   <td className="text-center">
                                <div className="widget-heading">{users.role == 'agence' ?  <p className=" btn btn-warning btn-sm" >Agence</p> : users.role == 'client'? 'client':'admin'}</div>
                      
                                   </td>
                                   <td className="text-center">
                                <div className="widget-heading">{users.status}</div>
                                   </td>
                               
                                <td className="text-center">
                                  <div className=" btn btn-danger btn-sm"  onClick={() => deleteuser(users.id)}> <i className="pe-7s-trash btn-icon-wrapper"></i> delete</div>
                                </td>
                                <td className="text-center">
